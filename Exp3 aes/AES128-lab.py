...
Hello = "/B?E(G+KbPeShVmY"
Hello = Hello.encode()

msgtoencrypt = input("Enter your string: ")
msgtoencrypt=msgtoencrypt.encode()
encData = enc(Hello,msgtoencrypt)
print("Encrypted String : ",encData)

decData = dec(Hello,encData)
print("Decrypted String: ",decData.decode())
